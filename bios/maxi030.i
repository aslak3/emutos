| core
		...
		.equ CORE8BASE, 0x40000000
		.equ LED, CORE8BASE+0x0
		.equ INTSENABLED, CORE8BASE+0x1
		.equ TIMERCONTROL, CORE8BASE+0x2
		.equ BUZZER, CORE8BASE+0x3

|		.equ SYSCONF, CORE8BASE+0x2
|		.equ PS2ASTATUS, CORE8BASE+0x3
|		.equ PS2ASCANCODE, CORE8BASE+0x4
|		.equ PS2BSTATUS, CORE8BASE+0x5
|		.equ PS2BSCANCODE, CORE8BASE+0x6
|		.equ I2CADDRESS, CORE8BASE+0x7
|		.equ I2CWRITE, CORE8BASE+0x8
|		.equ I2CREAD, CORE8BASE+0x9
|		.equ I2CCONTROL, CORE8BASE+0xa
|		.equ I2CSTATUS, I2CCONTROL
|		.equ RTCINTCONTROL, CORE8BASE+0xb
|		.equ SPIDATA, CORE8BASE+0xc

		.equ CORE32BASE, 0xc0000000
		.equ TIMERCOUNT, CORE32BASE+0x0
